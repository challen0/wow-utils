...
local AutoSellUnusableFrame = CreateFrame("Frame")
AutoSellUnusableFrame:RegisterEvent("MERCHANT_SHOW")
AutoSellUnusableFrame:SetScript("OnEvent", addonTable.AutoSellUnusable.OnMerchantShow)
